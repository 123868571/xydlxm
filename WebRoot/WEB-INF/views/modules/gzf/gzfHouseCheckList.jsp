...
<body>
	...
	<form:form id="searchForm" modelAttribute="gzfHousePerson" action="${ctx}/gzf/gzfHouseCheck/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<shiro:hasPermission name="gzf:gzfHouseCheck:edit"><th style="text-align:center;">操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="gzfHousePerson">
			<tr>
				...
				<shiro:hasPermission name="gzf:gzfHouseCheck:edit"><td style="text-align:center;">
				<a href="${ctx}/gzf/gzfHouseCheck/form?id=${gzfHousePerson.id}">验收房间</a>
