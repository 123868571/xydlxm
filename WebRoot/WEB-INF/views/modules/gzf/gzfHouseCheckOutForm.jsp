...
<body>
	...
	<div id="transferManage">
		<form:form id="inputForm" modelAttribute="gzfHousePerson" action="${ctx}/gzf/gzfHouseCheckOut/checkout" method="post" class="form-horizontal">
			<sys:message content="${message}"/>
			<div class="row-fluid">
				<div class="span12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption" style="color: rgb(77, 144, 254);"><i class="icon-edit"></i><span class="whiteFont">退房管理</span></div>
							<div class="tools">
									...
									<form:form id="inputForm" modelAttribute="gzfHousePerson" action="" method="post" class="form-horizontal">
										...
										<form:hidden path="id"/>								
											...
											<li>
												...
												<div class="controls">
													<span class="pad">${gzfHousePerson.water}</span>
												</div>
											</li>
											<li>
												<label class="control-label">水表单据号：</label>
												<div class="controls">
													<form:input path="waterOrder" htmlEscape="false" class="input-xlarge"/>
												</div>
											</li>
											<li>
												<label class="control-label">上传缴费单：</label>
												<div class="controls">
													<form:hidden id="waterPhoto" path="waterPhoto" htmlEscape="false" maxlength="255" class="input-xlarge" />
													<sys:ckfinder input="waterPhoto" type="images" uploadPath="/photo" selectMultiple="false" maxWidth="100" maxHeight="100"/>
												</div>
											</li>
											<li>
											...
											<li>
												...
												<div class="controls">
													<span class="pad">${gzfHousePerson.elec}</span>
												</div>
											</li>
											<li>
												<label class="control-label">电表单据号：</label>
												<div class="controls">
													<form:input path="elecOrder" htmlEscape="false" class="input-xlarge"/>
												</div>
											</li>
											<li>
												<label class="control-label">上传缴费单：</label>
												<div class="controls">
													<form:hidden id="elecPhoto" path="elecPhoto" htmlEscape="false" maxlength="255" class="input-xlarge" />
													<sys:ckfinder input="elecPhoto" type="images" uploadPath="/photo" selectMultiple="false" maxWidth="100" maxHeight="100"/>
												</div>
											</li>
											<li>
											...
											<li>
												<label class="control-label">天燃气表数：</label>
												<div class="controls">
													<span class="pad">${gzfHousePerson.gas}</span>
												</div>
											</li>
													<label class="control-label">天燃气表单据号：</label>
											<div class="controls">
												<form:input path="gasOrder" htmlEscape="false" class="input-xlarge"/>
											</div>
											<li>
												<label class="control-label">上传缴费单：</label>
												<div class="controls">
													<form:hidden id="gasPhoto" path="gasPhoto" htmlEscape="false" maxlength="255" class="input-xlarge" />
													<sys:ckfinder input="gasPhoto" type="images" uploadPath="/photo" selectMultiple="false" maxWidth="100" maxHeight="100"/>
												</div>
											</li>
											<li>
								...
								<ul class="unstyled span12 ">
									...
									<li class="no-padding no-margin">
										...
										<div class="pad">
											...
											${gzfHousePerson.gzfHouseInfo.buildNum}幢
											${gzfHousePerson.gzfHouseInfo.unit}单元
											${gzfHousePerson.gzfHouseInfo.room}室
										</div>
									</li>
