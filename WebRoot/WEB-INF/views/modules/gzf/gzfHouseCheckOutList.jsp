...
<body>
	...
	<form:form id="searchForm" modelAttribute="gzfHousePerson" action="${ctx}/gzf/gzfHouseCheckOut/" method="post" class="form-search">
		...
		<ul class="ul-form">
			<li class="input-append">
				...
				<button id="btnSubmit" type="button" class="btn blue"><i class="icon-search"></i> 搜索</button>
			</li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<shiro:hasPermission name="gzf:gzfHouseCheckOut:edit"><th style="text-align:center;">操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="gzfHousePerson">
			<tr>
				...
				<shiro:hasPermission name="gzf:gzfHouseCheckOut:edit"><td style="text-align:center;">
				<a href="${ctx}/gzf/gzfHouseCheckOut/form?id=${gzfHousePerson.id}">退房</a>
