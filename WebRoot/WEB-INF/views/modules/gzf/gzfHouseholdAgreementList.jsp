...
<body>
	<form:form id="searchForm" modelAttribute="gzfHousePerson" action="${ctx}/gzf/gzfHouseholdAgreement/" method="post" class="form-search">
		...
		<ul class="ul-form" style="position:relative;">
			...
			<li class="portlet-title pull-right" style="float:right">
				<button class="btn green imp-excel"><i class="icon-print"></i> 批量打印交房协议</button>
			</li>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<shiro:hasPermission name="gzf:gzfHouseholdAgreement:edit"><th style="text-align:center;">操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="gzfHousePerson">
			<tr>
				...
				<shiro:hasPermission name="gzf:gzfHouseholdAgreement:edit"><td style="text-align:center;">
				<a href="${ctx}/gzf/gzfHouseholdAgreement/form?id=${gzfHousePerson.id}">打印协议</a>|
				<a href="${ctx}/gzf/gzfHouseholdAgreement/form?id=${gzfHousePerson.id}">信息详情</a>
