...
<body>
	<div id="confirmation" class="row-fluid">
		<div class="span12">
			<div class="portlet">
				<div class="portlet-title bottom-line" style="border-bottom: #f5f5f5 1px solid;">
					<div class="caption" style="color: rgb(77, 144, 254);"><i class="icon-edit"></i>确认维修</div>
				</div>
				<div class="portlet-body">
					<div class="span8">								
						<form:form id="inputForm" modelAttribute="gzfMaintenance" action="${ctx}/gzf/gzfMaintenance/save" method="post" class="form-horizontal">
							...
							<form:hidden path="maintenanceId" value="3"/>
							...
							<div class="control-group ">
								...
								<div class="controls ">
									<c:forEach items="${repairTypeList}" var="gzfRepair">
									<div>
										${gzfRepair.gzfRepairProject.name },维修数量:${gzfRepair.num },维修备注:${gzfRepair.remarks }
									</div>
								</c:forEach>
								</div>
							...
							<div class="control-group ">
								...
								<div class="controls ">
									<div style="width:140px; " class="input-append date date-picker " data-date="2015-11-15 " data-date-format="yyyy-mm-dd " data-date-viewmode="years ">
										<input style="width:120px; " name="confirmTime" type="text" maxlength="20" class="m-wrap m-ctrl-medium date-picker Wdate "
											value="<fmt:formatDate value="${gzfMaintenance.confirmTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
							...
							<div class="control-group ">
								...
								<div class="controls ">
									<label class="radio line">
										...
										<form:input path="confirmPerson" placeholder="请输确认人姓名 " class="m-wrap small "/>
							...
							<div class="control-group ">
								<label class="control-label ">备注</label>
									<div class="controls ">
										<form:textarea path="confirmRemarks" htmlEscape="false" rows="4" maxlength="255" class="input-xxlarge "/>
									</div>
							</div>
							<div class="form-actions save-cancle ">
							<shiro:hasPermission name="gzf:gzfMaintenance:edit">
							<button id="confirm" class="btn blue margin-r-20 " type="submit" ><i class="icon-ok"></i> 确认</button></shiro:hasPermission>
