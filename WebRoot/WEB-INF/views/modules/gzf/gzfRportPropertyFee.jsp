...
<html>
    ...
    <body>
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <div class="span12">
                                                ...
                                                <form:form id="searchForm" modelAttribute="gzfAccount" action="${ctx}/gzf/gzfReport/fee/propertyDetail" method="post" class="breadcrumb form-search">
                                                    ...
                                                    <div id="infomanage-1-add">
                                                        ...
                                                        <div class="controls pull-left margin-r-20" style="margin-bottom: 10px">
                                                            ...
                                                            <div style="width:140px;" class="input-append">
                                                                <input id="show-report" style="height: 30px;line-height: 30px;padding-top: 0px" type="submit" onclick="doSubmit()" value="确定" />
                                                            </div>
                                                        ...
                                                        <div class="portlet-title pull-right">
                                                            ...
                                                            <a id="btnExport" data-type="2" href="javascript:" target="_blank" class="btn green"><i class="icon-share"></i> 导出Excel</a>
                                                        ...
                                                        <div id="info_manage_1">
                                                            <div class="portlet box blue">
                                                                ...
                                                                <div class="portlet-title">
                                                                    ...
                                                                    <div class="caption"><i class="icon-bar-chart"></i>物业费缴费详情</div>
                                                                    ...
                                                                    <table id="contentTable" class="table table-striped table-bordered table-condensed">
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th style="text-align:center;">物业费缴费状态</th>
                                                                                <th style="text-align:center;">欠费金额</th>
                                                                                <th style="text-align:center;">物业费缴费到期日期</th>
        ...
        <script>
            function doSubmit(){
                $("#searchForm").attr("action","${ctx}/gzf/gzfReport/fee/propertyDetail");
                $("#searchForm").submit();
            }
            function page(n,s){
                if(n) $("#pageNo").val(n);
