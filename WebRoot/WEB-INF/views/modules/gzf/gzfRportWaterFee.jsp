...
<html>
    ...
    <body>
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <div class="span12">
                                                ...
                                                <form:form id="searchForm" modelAttribute="gzfAccount" action="${ctx}/gzf/gzfReport/fee/waterDetail" method="post" class="breadcrumb form-search">
                                                    ...
                                                    <div id="infomanage-1-add">
                                                        ...
                                                        <div class="portlet-title pull-right">
                                                            ...
                                                            <a id="btnExport" data-type="4" href="javascript:" target="_blank" class="btn green"><i class="icon-share"></i> 导出Excel</a>
                                                        ...
                                                        <div id="info_manage_1">
                                                            <div class="portlet box blue">
                                                                ...
                                                                <div class="portlet-title">
                                                                    ...
                                                                    <div class="caption"><i class="icon-bar-chart"></i>水费缴费详情</div>
                                                                    ...
                                                                    <table id="contentTable" class="table table-striped table-bordered table-condensed">
                                                                        <thead>
                                                                            <tr>
                                                                                ...
                                                                                <th style="text-align:center;">水费缴费状态</th>
                                                                                <th style="text-align:center;">欠费金额</th>
                                                                                <th style="text-align:center;">水费缴费到期日期</th>
        ...
        <script>
            function doSubmit(){
                $("#searchForm").attr("action","${ctx}/gzf/gzfReport/fee/waterDetail");
                $("#searchForm").submit();
            }
            function page(n,s){
                if(n) $("#pageNo").val(n);
