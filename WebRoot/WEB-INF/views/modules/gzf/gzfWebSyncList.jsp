...
<body>
	...
	<form:form id="searchForm" modelAttribute="gzfHouseInfo" action="${ctx}/gzf/gzfWebSync/" method="post" class="breadcrumb form-search" style="background:#fff">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="gzfHouseInfo">
			<tr>
				...
				<td>
					${fns:getDictLabel(gzfHouseInfo.sync, 'house_sync', '已同步')}
				</td>
				<td>
				<a href="${ctx}/gzf/gzfWebSync/save?id=${gzfHouseInfo.id}">同步</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
