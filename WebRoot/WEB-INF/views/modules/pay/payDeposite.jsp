	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#search").click(function(){
				...
				var spePaymentId = "<%=PaymentConst.SPECIAL_PAYMENT.DEPOSIT%>";
		...
		<div id="payInfo" class="portlet-body">
			<div class="row-fluid">
				<div class="span12">
					<form:form id="searchForm" modelAttribute="gzfAccount" action="${ctx}/pay/gzfAccount/getDepositeHomePageInfo" method="post" class="form-search">
						...
						<div class="span12">
							<div class="portlet box blue">
								<div class="portlet-title">
									<div class="caption"><i class="icon-edit"></i><span class="whiteFont">押金缴费</span></div>
										<div class="tools">
											...
											<div class="tab-pane profile-classic row-fluid">
												<ul class="unstyled span6 ">
													...
													<li class="no-padding no-margin">
														...
														<div class="pad">${householdInfo.paymentStandard.deposit}</div>
		...
		<div class="portlet">
						<div class="portlet-title bottom-line">
							<div class="caption" style="color: rgb(77, 144, 254);"><i class="icon-reorder"></i>押金交费历史信息</div>
