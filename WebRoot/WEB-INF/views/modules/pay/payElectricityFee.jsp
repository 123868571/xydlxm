	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#search").click(function(){
				...
				var spePaymentId = "<%=PaymentConst.SPECIAL_PAYMENT.ELECTRICITY%>";
		...
		<div id="payInfo" class="portlet-body">
			<div class="row-fluid">
				<div class="span12">
					<form:form id="searchForm" modelAttribute="gzfAccount" action="${ctx}/pay/gzfAccount/getElectricityFeeHomePageInfo" method="post" class="form-search">
						...
						<div class="span12">
							<div class="portlet box blue">
								<div class="portlet-title">
									<div class="caption"><i class="icon-edit"></i><span class="whiteFont">电缴费</span></div>
										<div class="tools">
										...
										<div class="tabbable tabbable-custom tabbable-full-width">
											<div class="tab-pane profile-classic row-fluid">
												<ul class="unstyled span6 ">
													...
													<li class="no-padding no-margin">
														<span class="pad padWidth">电单价:</span>
														<div class="pad">${householdInfo.paymentStandard.electricityFee}</div>
														<span class="pad">元/度</span>
													</li>
													<li class="no-padding no-margin">
														<span class="pad padWidth">电表数(度):</span>
														<div class="pad">${gzfAccount.remarks}</div>
														<span class="pad">(未缴始-末)</span>
													</li>
													<li class="no-padding no-margin">
														<span class="pad padWidth">电费金额:</span>
														<div class="pad">
														<c:choose>
														...
														<c:when test="${gzfAccount.fee != null}">
															<a href="${ctx}/pay/gzfAccount/listAcctItem?accountId=${gzfAccount.id}&acctItemTypeId=<%=PaymentConst.ACCT_ITEM_TYPE.ELECTRICITY%>">查看帐单</a>
														</c:when>
														<c:otherwise></c:otherwise>
														</c:choose>
													</li>
					...
					<div class="portlet">
						<div class="portlet-title bottom-line">
							<div class="caption" style="color: rgb(77, 144, 254);"><i class="icon-reorder"></i>电交费历史信息</div>
