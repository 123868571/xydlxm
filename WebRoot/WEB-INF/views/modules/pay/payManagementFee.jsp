	...
	<script type="text/javascript">
		$(document).ready(function() {
			$("#search").click(function(){
				...
				var spePaymentId = "<%=PaymentConst.SPECIAL_PAYMENT.MANAGEMENT%>";
		...
		<div id="payInfo" class="portlet-body">
			<div class="row-fluid">
				<div class="span12">
					<form:form id="searchForm" modelAttribute="gzfAccount" action="${ctx}/pay/gzfAccount/getManagementFeeHomePageInfo" method="post" class="form-search">
						...
						<div class="span12">
							<div class="portlet box blue">
								<div class="portlet-title">
									<div class="caption"><i class="icon-edit"></i><span class="whiteFont">物业缴费</span></div>
										<div class="tools">
									...
									<div class="portlet-body form">
										<form:form id="houseForm" style="margin:0" modelAttribute="gzfPayment" action="${ctx}/pay/gzfAccount/payManagementFeeForm" method="post" class="form-horizontal">
										...
										<div class="tabbable tabbable-custom tabbable-full-width">
											<div class="tab-pane profile-classic row-fluid">
												<ul class="unstyled span6 ">
													...
													<li class="no-padding no-margin">
														<span class="pad padWidth">物业单价:</span>
														<div class="pad">${householdInfo.paymentStandard.managementFee}</div>
												...
												<ul class="unstyled span6 ">
													...
													<li>
														...
														<%--</button>--%>
														<button id="rentPayment" type="button" class="btn red" onclick="goToPay()"><i class="icon-yen"></i>物业缴费</button>
														</shiro:hasPermission>
													</li>
												</ul>
											</div>
					...
					<div class="portlet">
						<div class="portlet-title bottom-line">
							<div class="caption" style="color: rgb(77, 144, 254);"><i class="icon-reorder"></i>物业交费历史信息</div>
