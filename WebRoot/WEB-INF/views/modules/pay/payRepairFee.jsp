	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#search").click(function(){
				...
				var spePaymentId = "<%=PaymentConst.SPECIAL_PAYMENT.REPAIR_FEE%>";
		...
		<div id="payInfo" class="portlet-body">
			<div class="row-fluid">
				<div class="span12">
					<form:form id="searchForm" modelAttribute="gzfAccount" action="${ctx}/pay/gzfAccount/getRepairFeeHomePageInfo" method="post" class="form-search">
						...
						<div class="span12">
							<div class="portlet box blue">
								<div class="portlet-title">
									<div class="caption"><i class="icon-edit"></i><span class="whiteFont">设备维修费用缴费</span></div>
										<div class="tools">
								...
								<div class="portlet-body form">
										<form:form id="houseForm" style="margin:0" modelAttribute="gzfPayment" action="${ctx}/pay/gzfPayment/save" method="post" class="form-horizontal">
										<form:hidden path="id"/>
										...
										<div class="tabbable tabbable-custom tabbable-full-width">
											<div class="tab-pane profile-classic row-fluid">
												<ul class="unstyled span6 ">
													...
													<li class="no-padding no-margin">
														<span class="pad padWidth">房租生效日期:</span>
														<div class="pad">
														<c:choose>
														<c:when test="${gzfAccount.housePerson.startDate != null}">
														<fmt:formatDate value="${gzfAccount.housePerson.startDate}" pattern="yyyy-MM-dd"/>
														</c:when>
														<c:otherwise></c:otherwise>
														</c:choose>
														</div>
												...
												<ul class="unstyled span6 ">
													...
													<li class="no-padding no-margin">
														<span class="pad padWidth">待缴金额:</span>
													...
													<li>
														...
														<shiro:hasPermission name="pay:gzfPayment:payRepairFee">
															<button id="rentPayment" type="submit" class="btn red"><i class="icon-yen"></i>缴费</button>
														</shiro:hasPermission>
													</li>
												</ul>
											</div>
		...
		<div class="portlet">
						<div class="portlet-title bottom-line">
							<div class="caption" style="color: rgb(77, 144, 254);"><i class="icon-reorder"></i>交费历史信息</div>
