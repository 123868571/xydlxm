	...
	<script type="text/javascript">
		...
		function getBalanceRecord(){
			var url = "${ctx}/pay/gzfAccountPublic/listBalanceRecord";
				...
				<div class="portlet">
					<div class="portlet-body">
						<div class="row-fluid">
							<!-- Pricing -->
							<div class="row-fluid">
								<form:form id="searchForm" modelAttribute="gzfAccount" action="${ctx}/pay/gzfAccountPublic/getBalanceInfo" method="post" class="form-search">
									<div class="pull-left">
										<form:input path="phoneNo" htmlEscape="false" maxlength="100" class="input-medium" placeholder="请输入手机号查询" style="padding:6px;"/>
										<button type="submit" class="btn blue" onclick="query()"><i class="icon-search"></i>搜索</button>
									</div>
								</form:form>
							</div>
							...
							<div class="row-fluid margin-bottom-40">
								...
								<div class="span3 pricing hover-effect">
									...
									<div class="pricing-footer">
										...
										<a href="javascript:;" data-url="${ctx}/pay/gzfAccountPublic/payFreeFee?accountId=${gzfBalanceRecord.accountId}&spePaymentId=<%=PaymentConst.SPECIAL_PAYMENT.NO_SPECIAL %>&phoneNo=${gzfAccount.phoneNo}&custId=${gzfAccount.custId}" class="recharge btn green">
								...
								<div class="span3 pricing hover-effect">
									...
									<div class="pricing-footer">
										...
										<a href="javascript:;" data-url="${ctx}/pay/gzfAccountPublic/transferForm?destAcctId=${gzfBalanceRecord.accountId}&srcSpecPaymentId=<%=PaymentConst.SPECIAL_PAYMENT.NO_SPECIAL %>&destSpecPaymentId=<%=PaymentConst.SPECIAL_PAYMENT.HOUSE_RENT %>&totalFreeFee=${freeBalance}&phoneNo=${gzfAccount.phoneNo}&custId=${gzfAccount.custId}" class="btn green">
								...
								<div class="span3 pricing hover-effect">
									<div class="pricing-head">
										<h3>水电燃气费</h3>
										<h4><i>￥</i><fmt:formatNumber value="${waterBalance/100}" maxFractionDigits="2" pattern=""></fmt:formatNumber><span></span></h4>
									</div>
									<div class="pricing-footer">
										<p>您可以执行如下操作：<br>
											1、点击“转入”转入交费金额<br>
										...
										<a href="javascript:;" data-url="${ctx}/pay/gzfAccountPublic/transferForm?destAcctId=${gzfBalanceRecord.accountId}&srcSpecPaymentId=<%=PaymentConst.SPECIAL_PAYMENT.NO_SPECIAL %>&destSpecPaymentId=<%=PaymentConst.SPECIAL_PAYMENT.WATER %>&totalFreeFee=${freeBalance}&phoneNo=${gzfAccount.phoneNo}&custId=${gzfAccount.custId}" class="btn green">
											转入 <i class="m-icon-swapright m-icon-white"></i>
										</a>  
									</div>
								</div>
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<div class="portlet">
							...
							<form:form id="searchFormm" modelAttribute="gzfBalanceRecord" action="${ctx}/pay/gzfAccountPublic/listBalanceRecord" method="post">
							<div class="portlet-title">
