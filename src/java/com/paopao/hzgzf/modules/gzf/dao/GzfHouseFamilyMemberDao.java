...
/**
 * ClassName: GzfHouseFamilyMemberDao <br/>
 * Function: gzf_house_family_member mapper. <br/>
 ...
 */
@MyBatisDao
public interface GzfHouseFamilyMemberDao extends CrudDao<GzfHouseFamilyMember> {
