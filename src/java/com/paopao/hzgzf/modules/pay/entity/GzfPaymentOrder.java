 ...
 * @version 2016-04-25
 */
public class GzfPaymentOrder extends DataEntity<GzfPaymentOrder> {
	...
	public GzfPaymentOrder() {
		super();
	}

	public GzfPaymentOrder(String id){
		super(id);
	}
	...
	@Length(min=0, max=64, message="根据凭证类型记录不同的信息。长度必须介于 0 和 64 之间")
