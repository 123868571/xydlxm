...
import com.paopao.hzgzf.common.utils.CookieUtils;
...
import com.paopao.hzgzf.modules.sys.security.FormAuthenticationFilter;
...
public class LoginController extends BaseController {
    ...
    public String login(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        //		view = "classpath:";
        //		view += "jar:file:/D:/GitHub/hzgzf/src/main/webapp/WEB-INF/lib/hzgzf.jar!";
...
//                sessionDAO.getActiveSessions(false).size(), message, exception);
    ...
    public String index(HttpServletRequest request, HttpServletResponse response) {
        ...
        //		try {
        //			byte[] bytes = com.thinkgem.hzgzf.common.utils.FileUtils.readFileToByteArray(
        //					com.thinkgem.hzgzf.common.utils.FileUtils.getFile("c:\\sxt.dmp"));
        ...
        request.getSession().setAttribute("repairNum", page.getCount());
        return "modules/sys/sysIndex";
    }
