 ...
 */
        ...
        public  class SystemException extends org.datacontract.schemas._2004._07.system.Exception
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                String namespace = null;
                   ...
                   String namespacePrefix = registerPrefix(xmlWriter,"http://schemas.datacontract.org/2004/07/System");
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SystemException",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "SystemException",
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/System","SystemException"));
                 if (localExtraElementTracker){
                            if (localExtraElement != null) {
                                for (int i = 0;i < localExtraElement.length;i++){
                                    if (localExtraElement[i] != null){
    ...
    public static class Factory{
        ...
        */
        public static SystemException parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SystemException".equals(type)){
                                ...
                                return (SystemException)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
