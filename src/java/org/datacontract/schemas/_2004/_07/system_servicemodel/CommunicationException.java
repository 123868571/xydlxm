 ...
 */
            ...
            /**
            *  CommunicationException bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CommunicationException extends org.datacontract.schemas._2004._07.system.SystemException
                ...
                String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CommunicationException",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/System.ServiceModel","CommunicationException"));
                 if (localExtraElementTracker){
                            if (localExtraElement != null) {
                                for (int i = 0;i < localExtraElement.length;i++){
                                    if (localExtraElement[i] != null){
                            ...
                            new javax.xml.namespace.QName("http://schemas.microsoft.com/2003/10/Serialization/","FactoryType"));
                                      ...
                                      attribList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localFactoryType));
    ...
    public static class Factory{
        ...
        */
        public static CommunicationException parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            CommunicationException object =
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CommunicationException".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CommunicationException)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    String tempAttribFactoryType =
                        
                                reader.getAttributeValue("http://schemas.microsoft.com/2003/10/Serialization/","FactoryType");
                   ...
                   if (tempAttribFactoryType!=null){
                         String content = tempAttribFactoryType;
                                ...
                                namespaceuri = reader.getNamespaceURI(prefix);
                                         ...
                                         object.setFactoryType(
                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToQName(tempAttribFactoryType,namespaceuri));
