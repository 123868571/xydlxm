 ...
 */
        ...
        public  class FaultException extends org.datacontract.schemas._2004._07.system_servicemodel.CommunicationException
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/System.ServiceModel","FaultException"));
                 if (localExtraElementTracker){
                            if (localExtraElement != null) {
                                for (int i = 0;i < localExtraElement.length;i++){
                                    if (localExtraElement[i] != null){
    ...
    public static class Factory{
        ...
        */
        public static FaultException parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FaultException".equals(type)){
                                ...
                                return (FaultException)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
