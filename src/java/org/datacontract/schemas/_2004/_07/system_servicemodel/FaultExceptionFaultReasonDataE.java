...
/**
 * FaultExceptionFaultReasonDataE.java
 *
 ...
 */
            ...
            /**
            *  FaultExceptionFaultReasonDataE bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class FaultExceptionFaultReasonDataE
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                //We can safely assume an element has only one type associated with it
                                      ...
                                      if (localFaultExceptionFaultReasonData==null){
                                        ...
                                        writeStartElement(null, namespace, "FaultException.FaultReasonData", xmlWriter);

                                        // write the nil attribute
                                        writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                        xmlWriter.writeEndElement();
                                       }else{
                                         localFaultExceptionFaultReasonData.serialize(MY_QNAME,xmlWriter);
                                       }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                                ...
                                if (localFaultExceptionFaultReasonData==null){
                                   ...
                                   return localFaultExceptionFaultReasonData.getPullParser(MY_QNAME);
                                }
    ...
    public static class Factory{
        ...
        */
        public static FaultExceptionFaultReasonDataE parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            FaultExceptionFaultReasonDataE object =
                new FaultExceptionFaultReasonDataE();
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://schemas.datacontract.org/2004/07/System.ServiceModel","FaultException.FaultReasonData").equals(reader.getName())){
                                      ...
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setFaultExceptionFaultReasonData(null);
                                          reader.next();
                                          
                                      }else{
                                    
                                                object.setFaultExceptionFaultReasonData(org.datacontract.schemas._2004._07.system_servicemodel.FaultExceptionFaultReasonData.Factory.parse(reader));
                                            }
