 ...
 */
            ...
            /**
            *  AddRenterResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AddRenterResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AddRenterResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AddRenterResponse",
    ...
    public static class Factory{
        ...
        */
        public static AddRenterResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            AddRenterResponse object =
                new AddRenterResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AddRenterResponse".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AddRenterResponse)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
