 ...
 */
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localRoomTracker){
                                    if (localRoom==null){
                                        ...
                                        writeStartElement(null, "http://tempuri.org/", "room", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localRoom.serialize(new javax.xml.namespace.QName("http://tempuri.org/","room"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
    ...
    public static class Factory{
        ...
        */
        public static AddRoom parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            AddRoom object =
                new AddRoom();
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AddRoom".equals(type)){
                                ...
                                return (AddRoom)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
