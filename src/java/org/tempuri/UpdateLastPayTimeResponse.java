...
/**
 * UpdateLastPayTimeResponse.java
 *
 ...
 */
            ...
            /**
            *  UpdateLastPayTimeResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class UpdateLastPayTimeResponse
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://tempuri.org/",
                "UpdateLastPayTimeResponse",
                "ns3");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UpdateLastPayTimeResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "UpdateLastPayTimeResponse",
    ...
    public static class Factory{
        ...
        */
        public static UpdateLastPayTimeResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            UpdateLastPayTimeResponse object =
                new UpdateLastPayTimeResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UpdateLastPayTimeResponse".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UpdateLastPayTimeResponse)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
