 ...
 */
            ...
            /**
            *  UpdateRenterResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class UpdateRenterResponse
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UpdateRenterResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "UpdateRenterResponse",
    ...
    public static class Factory{
        ...
        */
        public static UpdateRenterResponse parse(javax.xml.stream.XMLStreamReader reader) throws Exception{
            UpdateRenterResponse object =
                new UpdateRenterResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UpdateRenterResponse".equals(type)){
                                //find namespace for the prefix
                                String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UpdateRenterResponse)org.tempuri.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
